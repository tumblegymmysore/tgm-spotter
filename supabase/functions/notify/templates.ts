...
export const generateWelcomeEmail = (data: any) => {
  ...
  const consentBadge = data.marketing_consent 
    ? `<span style="background-color: #dcfce7; color: #166534; padding: 4px 8px; border-radius: 99px; font-size: 12px; font-weight: bold;">✅ Yes</span>` 
    : `<span style="background-color: #fee2e2; color: #991b1b; padding: 4px 8px; border-radius: 99px; font-size: 12px; font-weight: bold;">❌ No</span>`;
    ...
    <html>
      <head>
        <style>
          ...
          .row { display: flex; justify-content: space-between; margin-bottom: 8px; border-bottom: 1px solid #e2e8f0; padding-bottom: 8px; }
        ...
        <div class="container">
          ...
          <div class="content">
            ...
            <div class="data-box">
              ...
              <div class="row"><span class="label">Alternate</span> <span class="value">${data.alternate_phone || 'None'}</span></div>
              <div class="row"><span class="label">Address</span> <span class="value">${data.address || 'N/A'}</span></div>
            </div>

            <div class="section-title">Details</div>
            <div class="data-box">
              <div class="row"><span class="label">Source</span> <span class="value">${data.source || 'N/A'}</span></div>
              <div class="row"><span class="label">Intent</span> <span class="value">${data.intent || 'N/A'}</span></div>
              <div class="row"><span class="label">Marketing</span> <span class="value">${consentBadge}</span></div>
            </div>
          ...
          <div class="footer">Spotter System Notification</div>
        </div>
      </body>
    </html>
  `
